...
msv.on("message", message => {
  if (message.content === prefix + "owner") {
    ...
    let embed = new Discord.MessageEmbed()
      .setColor(msvcolor)
      .setImage(`https://images-ext-2.discordapp.net/external/bXwfBd91nxEK9Jsj5URfEP89n9tDI6VGNw5AvT3m1Kc/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/720218422222520410/90c1cb3b77ace89cde1f927c09020c23.png?width=234&height=234`)
      .setDescription(`OwnerCode (Msv)`)
